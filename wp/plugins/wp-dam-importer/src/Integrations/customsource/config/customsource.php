...
return [
    'name'         => 'customsource',
    'description'  => 'Add a custom data source.',
    'logo'         => 'customsource.png',
    'active'       => env('CUSTOMSOURCE_ACTIVE', true),
    'type'         => PackageTypes::SOURCE->value,
    'instructions' => 'readme.md',

    'callback_endpoint' => '/api/store-file/callback',

    'defaults' => [
        'sync_mode'     => PackageSyncMode::MANUAL,
        'sync_interval' => PackageInterval::EVERY_MONTH,
        'sync_options'  => [
