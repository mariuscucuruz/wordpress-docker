...
use MariusCucuruz\DAMImporter\Integrations\Nataero\Webhooks\Strategies\MediaSneakpeekStrategy;
use MariusCucuruz\DAMImporter\Integrations\Nataero\Webhooks\Strategies\NataeroWebhookProcessor;

class ProcessNataeroSneakpeekWebhookJob extends ProcessWebhookJob
{
    ...
    public function handle(
        ...
        MediaSneakpeekStrategy $strategy,
    ): void {
        ...
        NataeroResultProcessor::processMediaSneakpeekResults($ctx->results, $ctx->task);
    }
}
