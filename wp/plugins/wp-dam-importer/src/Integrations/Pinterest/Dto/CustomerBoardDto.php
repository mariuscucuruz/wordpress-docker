...
namespace MariusCucuruz\DAMImporter\Integrations\Pinterest\Dto;

use MariusCucuruz\DAMImporter\DTOs\FolderEntryDTO;

class CustomerBoardDto extends FolderEntryDTO
{
    ...
    public function __construct(iterable $properties = [])
    {
        ...
        $this->items = array_filter([
            ...data_get($properties, 'media.pin_thumbnail_urls', []),
